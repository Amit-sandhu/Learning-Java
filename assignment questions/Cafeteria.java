...
// Practice: Add a removeFoodItem() concept - a method that decreases
// totalFoodItems, and think about why it can't fully "remove" an item
// without a collection like an ArrayList (see collections/ folder).
